...
from itp_forms.core.views import BaseConfigurationView, IndexView, get_form, get_result, interpret_answers_view, results_view, save_current_config, set_marker, update_image
